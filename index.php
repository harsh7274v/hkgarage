        ...
        <div class="pt-6 border-t border-ink/5">
          ...
          <div class="animate-marquee-reverse flex items-center gap-16 py-2">
            ...
            $everydayBrands = [
              ...
              ['name' => 'BYD', 'logo' => 'assets/logos/byd.svg'],
              ['name' => 'Omoda', 'logo' => 'assets/logos/omoda.svg'],
              ['name' => 'Jaecoo', 'logo' => 'assets/logos/jaecoo.svg'],
              ['name' => 'XPeng', 'logo' => 'assets/logos/xpeng.svg'],
              ['name' => 'MG', 'logo' => 'assets/logos/mg.svg'],
              ['name' => 'DR', 'logo' => 'assets/logos/dr.png'],
